...
if (langs.includes(langCode)){
  ...
  if (langCode=='ja'){
    ...
    document.documentElement.style.setProperty('--main-font', "'Ping Medium', 'M PLUS 1p', sans-serif");
    document.documentElement.style.setProperty('--title-font', "'Ping Heavy', sans-serif");
  }else{
